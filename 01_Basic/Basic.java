public class Basic {
    public static void main(String[] args) {
        ...
        byte m;
        m = 3;
        // m은 1바이트(8비트)니까 3이 저장되면 2진수로 변경되어서 11, 8비트를 채우면 00000011

        // 정수형의 표현범위
        // n비트로 표현할 수 있는 값의 개수 : 2^n개, 8비트는 2^8 = 256개 값 표현 가능
        // n비트로 표현할 수 있는 부호없는 정수 범위 : 0 ~ 2^n-1 (0을 포함시켜서 1빼기)
        // n비트로 표현할 수 있는 부호있는 정수 범위 : -2^(n-1) ~ 2^(n-1)-1
